...
export function createCandidateEntityRef(
  entity: Pick<CandidateEntity, "kind" | "traceId"> &
    Partial<Pick<CandidateClause, "candidateClauseId">> &
    Partial<Pick<CandidateTerm, "candidateTermId">>
): CandidateEntityRef {
  const ref: CandidateEntityRef = {
    kind: entity.kind,
    id:
      entity.kind === "candidate_clause"
        ? (entity.candidateClauseId as CandidateClauseId)
        : (entity.candidateTermId as CandidateTermId),
  };
